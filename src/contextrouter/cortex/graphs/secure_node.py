    ...
    *,
    ...
    def _resolve_scopes(state: StateT) -> list[str]:
        ...
        if isinstance(state, dict):
            ...
            from contextrouter.cortex.graphs.config_resolution import get_node_config
    ...
    def _check_prompt_integrity(state: StateT) -> None:
        ...
        from contextcore.sdk.prompt_integrity import verify_prompt
        ...
        if not verify_prompt(prompt_text, actual_signature, backend):
            from contextcore.exceptions import TamperDetectedError
