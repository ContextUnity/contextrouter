...
from contextunity.router.core import TokenBuilder, UserCtx, get_core_config
from contextunity.router.cortex import compile_graph, get_last_user_query
from contextunity.router.cortex.callbacks.tool_handler import ToolEventCallbackHandler
from contextunity.router.modules.observability import get_langfuse_callbacks, trace_context
from contextunity.router.modules.retrieval.rag import (
...
async def _mint_access_token(
    ...
    try:
        from contextunity.core.permissions import has_graph_access
