    ...
    *,
    ...
    async def normalize(state: GardenerState) -> dict:
        ...
        if execution_mode == "batch_status":
            from contextunity.router.core.config import get_config
            from contextunity.router.modules.models.llm.openai_batch import OpenAIBatchClient
            ...
            from contextunity.router.modules.models.llm.openai_batch import (
                BatchRequest,
                OpenAIBatchClient,
            )
