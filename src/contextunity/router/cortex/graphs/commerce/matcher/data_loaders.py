...
and Knowledge Graph edges from contextunity.brain for use in RLM product matching.
...
class RLMDataLoader:
    ...
    async def load_taxonomy(self) -> TaxonomyData:
        """Load taxonomy data from contextunity.brain.
        ...
        try:
            ...
            logger.warning("contextunity.core not installed, returning empty taxonomy")
            return TaxonomyData()
    ...
    async def load_knowledge_graph(self) -> KnowledgeGraphData:
        """Load Knowledge Graph edges from contextunity.brain.
        ...
        try:
            ...
            logger.warning("contextunity.core not installed, returning empty KG")
