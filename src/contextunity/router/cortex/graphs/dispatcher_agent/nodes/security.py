...
from contextunity.router.cortex.graphs.dispatcher_agent.state import (
    DispatcherState,
...
async def security_guard_node(state: DispatcherState) -> DispatcherStateUpdate:
    ...
    for tool_call in last_message.tool_calls:
        ...
        if token_permissions is not None:
            from contextunity.core.permissions import has_tool_access
        ...
        from contextunity.core.permissions import ToolRisk, check_tool_scope
