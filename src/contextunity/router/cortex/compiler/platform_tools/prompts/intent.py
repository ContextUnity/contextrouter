"""Intent detection prompt templates -- classify user messages into action categories (search, chat, tool-call)."""
...
INTENT_DETECTION_PROMPT = (
    ...
    "INTENTS:\n"
    "- rag: Questions requiring source retrieval\n"
    ...
    "- selected_sources: List of data source bindings to route the query to. If provided DATA SOURCES below, pick the bindings that best match the query. If no relevant sources or DATA SOURCES is empty, return [].\n\n"
    "JSON SCHEMA:\n"
    "{\n"
    '  "intent": "rag" | "translate" | "summarize" | "rewrite" | "identity" | "sql" | "web_search",\n'
