...
def discover_all_tools() -> list[SecureTool]:
    ...
    try:
        from contextunity.router.cortex.graphs.commerce import tools as commerce_tools
    ...
    try:
        from contextunity.router.cortex.graphs.news_engine.agents import language_tool
    ...
    try:
        from contextunity.router.modules.tools.sql import (  # noqa: F401
            SQLToolConfig,
            create_sql_tools,
        )
    ...
    try:
        ...
        # Tools are auto-registered when module is imported
        logger.debug("contextunity.zero privacy tools loaded")
    except ImportError:
    ...
    try:
        from contextunity.router.modules.tools import gcs_tools  # noqa: F401
    ...
    try:
        from contextunity.router.modules.tools import brain_trace_tools  # noqa: F401
