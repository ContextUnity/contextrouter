...
def _ensure_builtin_graphs_loaded():
    ...
    _graph_modules = [
        "contextunity.router.cortex.graphs.commerce.graph",
        "contextunity.router.cortex.graphs.commerce.matcher.graph",
        "contextunity.router.cortex.graphs.tool_executor.graph",
    ]
    import importlib
